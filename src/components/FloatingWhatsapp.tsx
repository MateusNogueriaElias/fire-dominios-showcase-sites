...
const WhatsAppFloatingButton = () => {
  ...
  const whatsappNumber = "5511972492813"; // Substitua pelo seu número
      ...
      <div className="relative">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="font-semibold text-sm text-gray-800">Fale com um especialista</div>
              <div className="text-xs text-gray-500">
                {isOnline ? "🟢 Online agora" : "🔴 Respondemos em breve"}
              </div>
            </div>
          </div>
        ...
        <button
          ...
          aria-label="Minimizar" // <-- ETIQUETA ACESSÍVEL
        >
